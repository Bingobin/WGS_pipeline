...
my ($mutect2, $strelka, $varscan, $somaticsniper, $muse, $vardict, $help);
GetOptions(
		"mutect2:s" => \$mutect2,
		"strelka:s" => \$strelka,
		"varscan:s" => \$varscan,
		"somaticsniper:s" => \$somaticsniper,
		"muse:s" => \$muse,
		"vardict:s" => \$vardict,
		"h"=>\$help,
...
Author:Liuyabin
Data: 2018-10
usage:perl $0 -mutect2 <snv.process> -strelka <snv.process>  -varscan <snv.process> -somaticsniper <snv.process> -muse <snv.process> -vardict <snv.process>
USAGE

die $usage if (!$mutect2 || !$vardict || !$varscan || !$somaticsniper || !$muse || !$strelka || $help);
...
read_input($somaticsniper, "SomaticSniper", \%hash);
read_input($muse, "MuSE", \%hash);
